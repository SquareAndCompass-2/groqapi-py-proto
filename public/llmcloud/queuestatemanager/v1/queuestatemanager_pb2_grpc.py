...
from public.llmcloud.queuestatemanager.v1 import queuestatemanager_pb2 as public_dot_llmcloud_dot_queuestatemanager_dot_v1_dot_queuestatemanager__pb2
...
def add_QueueStateManagerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'public.llmcloud.queuestatemanager.v1.QueueStateManagerService', rpc_method_handlers)
...
class QueueStateManagerService(object):
    ...
    def GetRequestState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/public.llmcloud.queuestatemanager.v1.QueueStateManagerService/GetRequestState',
